...
class RedisClient
  class Cluster
    class Slot
      ...
      def build_slot_node_key_map(available_slots) # rubocop:disable Metrics/AbcSize, Metrics/CyclomaticComplexity, Metrics/MethodLength, Metrics/PerceivedComplexity
        by_ranges = {}
